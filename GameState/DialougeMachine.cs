...
public partial class DialougeMachine : Node
{
	...
	public override void _Ready()
	{
		...
		Descriptions.Add("bread_0", "Nice work with the day, but I helped you out with the buns. A real weiner master works their OWN buns.\n");
		Descriptions.Add("bread_1", "My stand only uses the BEST buns, so the bread is delicate. Make sure to stock up on extra! Customers wont want a hotdog without the bun.\n\n - Each bun has a 20% chance of being wasted.\n");
		Descriptions.Add("freshness_0", "That was alright work, but I helped your hotdogs fresh. A real weiner master has to manage the freshness of the hotdogs that they make.\n The freshness of your hotdogs will be determine how much tip a customer leaves!\n");
		Descriptions.Add("freshness_1", "Each batch of hotdogs will be freshest when they are done. They will then decrease in freshness as time goes on for 10 seconds. They will then reach their base freshness, which won't impress any customer enough to tip!\n\n - Every batch stays fresh for 10 seconds\n - The tips the customers leave is determined by how much time is left on the freshness timer");
